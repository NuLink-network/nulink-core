...
docker-compose -f $COMPOSE_FILE run -w $DEMO_DIR nulink-dev python3 alicia.py 172.28.1.3:11500

# Run Dr. Bob
echo "Starting Bob..."
docker-compose -f $COMPOSE_FILE run -w $DEMO_DIR nulink-dev python3 doctor.py 172.28.1.3:11500
