...
from nulink.characters.control.controllers import CharacterCLIController
from nulink.control.controllers import JSONRPCController
...
from nulink.crypto.signing import (
    SignatureStamp,
    StrangerStamp,
)
...
class Character(Learner):
    ...
    def __init__(self,
        ...
        A participant in the cryptological drama (a screenplay, if you like) of NuLink.
