...
from nulink.crypto.powers import CryptoPower
...
class Amonia(Alice):
    ...
    def grant_without_paying(self, *args, **kwargs):
        ...
        with patch("nulink.policy.policies.BlockchainPolicy._publish", what_do_you_mean_you_dont_tip):
    ...
    def circumvent_safegaurds_and_grant_without_paying(self, *args, **kwargs):
        ...
        """
        with patch("nulink.policy.policies.Policy._publish", self.grant_without_paying):
