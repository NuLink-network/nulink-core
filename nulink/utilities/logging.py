...
class _SentryInitGuard:
    ...
    @classmethod
    def init(cls, dsn: str = NULINK_SENTRY_ENDPOINT):
...
class Logger(TwistedLogger):
    ...
    See Issue #724 and, particularly, https://github.com/NuLink-network/nulink-core/issues/724#issuecomment-600190455"""
