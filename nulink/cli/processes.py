...
class UrsulaCommandProtocol(LineReceiver):
    ...
    def paintKnownNodes(self):
        ...
        """
        from nulink.cli.painting.nodes import paint_known_nodes
    ...
    def paintStatus(self):
        ...
        """
        from nulink.cli.painting.nodes import paint_node_status
    ...
    def paintFleetState(self):
        ...
        """
        from nulink.cli.painting.nodes import build_fleet_state_status
...
class JSONRPCLineReceiver(LineReceiver):
    ...
    encoding = 'utf-8'
    delimiter = os.linesep.encode(encoding=encoding)
    __ipc_endpoint = Path("/tmp/nulink.ipc")
