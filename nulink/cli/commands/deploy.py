...
from nulink.blockchain.eth.constants import STAKING_ESCROW_CONTRACT_NAME
...
from nulink.cli.actions.confirm import confirm_deployment, verify_upgrade_details
from nulink.cli.actions.select import select_client_account
...
from nulink.cli.painting.deployment import (
    paint_contract_deployment,
    paint_deployer_contract_inspection,
    paint_staged_deployment
)
from nulink.cli.painting.help import echo_solidity_version
from nulink.cli.painting.transactions import paint_receipt_summary
from nulink.cli.types import EIP55_CHECKSUM_ADDRESS, EXISTING_READABLE_FILE, WEI
...
def upgrade(general_config, actor_options, retarget, target_address, ignore_deployed, confirmations):
    """Upgrade NuLink existing proxy contract deployments."""
