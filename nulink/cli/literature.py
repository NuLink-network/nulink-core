...
"""Text blobs that are implemented as part of nulink CLI emitter messages."""
...
NO_CONFIGURATIONS_ON_DISK = "No {name} configurations found. Run 'nulink {command} init' then try again."
...
SUCCESSFUL_DESTRUCTION = "Successfully destroyed nulink configuration"
...
COLLECT_NULINK_PASSWORD = 'Enter nulink keystore password'
...
PROMPT_TOKEN_VALUE = "Enter value in NLK"

PROMPT_RECIPIENT_CHECKSUM_ADDRESS = "Enter recipient's checksum address"

DISPLAY_SENDER_TOKEN_BALANCE_BEFORE_TRANSFER = "Deployer NLK balance: {token_balance}"
...
Did you mean 'nulink-deploy upgrade'?
"""
...
* cp {local_registry.filepath} nulink/blockchain/eth/contract_registry/{network}/contract_registry.json
* git add nulink/blockchain/eth/contract_registry/{network}/contract_registry.json
