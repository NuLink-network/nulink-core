...
from nulink.config.constants import SeednodeMetadata
...
from nulink.crypto.signing import InvalidSignature, SignatureStamp
...
TEACHER_NODES = {
    ...
    NetworksInventory.BSC_TESTNET: ("https://127.0.0.1:9151",),  # dev server for greenfield sp
    NetworksInventory.HORUS: ("https://127.0.0.1:9151",),
