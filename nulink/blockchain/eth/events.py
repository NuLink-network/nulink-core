...
from nulink.config.constants import NULINK_EVENTS_THROTTLE_MAX_BLOCKS
...
class ContractEventsThrottler:
    ...
    DEFAULT_MAX_BLOCKS_PER_CALL = int(os.environ.get(NULINK_EVENTS_THROTTLE_MAX_BLOCKS, 1000))
