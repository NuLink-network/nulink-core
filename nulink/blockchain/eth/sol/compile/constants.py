...
from nulink.config.constants import NULINK_TEST_DIR
...
TEST_SOLIDITY_SOURCE_ROOT: Path = Path(NULINK_TEST_DIR) / CONTRACTS / CONTRACTS
TEST_MULTIVERSION_CONTRACTS: Path = Path(NULINK_TEST_DIR) / 'acceptance' / 'blockchain' / 'interfaces' / 'test_contracts' / 'multiversion'

from nulink.blockchain.eth import sol
