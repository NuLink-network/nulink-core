...
from nulink.blockchain.eth.constants import (
...
from nulink.config.constants import (
    NULINK_ENVVAR_STAKING_PROVIDERS_PAGINATION_SIZE_LIGHT_NODE,
    NULINK_ENVVAR_STAKING_PROVIDERS_PAGINATION_SIZE
)
...
class PREApplicationAgent(EthereumContractAgent):
    ...
    DEFAULT_PROVIDERS_PAGINATION_SIZE = int(os.environ.get(NULINK_ENVVAR_STAKING_PROVIDERS_PAGINATION_SIZE, default=1000))
    ...
    def confirm_operator_address(self, transacting_power: TransactingPower, fire_and_forget: bool = True) -> TxReceipt:
        ...
        # 质押的操作者确认与质押者正确绑定的操作
        # https://github.com/NuLink-network/nulink-core-contracts/blob/d5752ce874f7ec132c96851878cf204499c59ff0/contracts/contracts/SimplePREApplication.sol
...
class ContractAgency:
    ...
    def _contract_name_to_agent_name(name: str) -> str:
        if name == NULINK_TOKEN_CONTRACT_NAME:
            # TODO: Perhaps rename NulinkTokenAgent
            name = "NuLinkToken"
