...
from nulink.characters.control.specifications.fields import Key, TreasureMap
from nulink.characters.lawful import Enrico
from nulink.crypto.powers import DecryptingPower
from nulink.utilities.porter.control.specifications.fields import RetrievalKit as RetrievalKitField
...
def retrieval_params_decode_from_rest(retrieval_params: Dict) -> Dict:
    ...
    return dict(treasure_map=decode_bytes(TreasureMap, retrieval_params['treasure_map']),
                ...
                cross_chain_hrac=decode_bytes(CrossChainHRAC, retrieval_params['cross_chain_hrac']))
