...
from nulink.blockchain.eth.sol.compile.aggregation import DEVDOC_VERSION_PATTERN
from nulink.blockchain.eth.sol.compile.constants import DEFAULT_VERSION_STRING
