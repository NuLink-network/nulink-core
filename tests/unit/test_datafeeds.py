...
from nulink.utilities.datafeeds import (
    Datafeed,
...
from nulink.utilities.gas_strategies import construct_datafeed_median_strategy
...
def test_etherchain():
    ...
    with patch('nulink.utilities.datafeeds.EtherchainGasPriceDatafeed._parse_gas_prices', autospec=True):
...
def test_upvest():
    ...
    with patch('nulink.utilities.datafeeds.UpvestGasPriceDatafeed._parse_gas_prices', autospec=True):
...
def test_zoltu():
    ...
    with patch('nulink.utilities.datafeeds.ZoltuGasPriceDatafeed._parse_gas_prices', autospec=True):
...
def test_datafeed_median_gas_price_strategy():
    ...
    with patch('nulink.utilities.datafeeds.UpvestGasPriceDatafeed.construct_gas_strategy',
               return_value=construct_mock_gas_strategy(mock_upvest_gas_price)):
        # with patch('nulink.utilities.datafeeds.EtherchainGasPriceDatafeed.construct_gas_strategy',
        #            return_value=construct_mock_gas_strategy(mock_etherchain_gas_price)):
        with patch('nulink.utilities.datafeeds.ZoltuGasPriceDatafeed.construct_gas_strategy',
    ...
    with patch('nulink.utilities.datafeeds.UpvestGasPriceDatafeed._probe_feed',
    ...
    with patch('nulink.utilities.datafeeds.UpvestGasPriceDatafeed._probe_feed',
               side_effect=Datafeed.DatafeedError):
        # with patch('nulink.utilities.datafeeds.EtherchainGasPriceDatafeed._probe_feed',
        #            side_effect=Datafeed.DatafeedError):
        with patch('nulink.utilities.datafeeds.ZoltuGasPriceDatafeed.construct_gas_strategy',
                   return_value=construct_mock_gas_strategy(mock_zoltu_gas_price)):
            datafeed_median_gas_price_strategy = construct_datafeed_median_strategy()
    ...
    with patch('nulink.utilities.datafeeds.UpvestGasPriceDatafeed._probe_feed',
               side_effect=Datafeed.DatafeedError):
        with patch('nulink.utilities.datafeeds.ZoltuGasPriceDatafeed._probe_feed',
               side_effect=Datafeed.DatafeedError):
            with patch('nulink.utilities.gas_strategies.rpc_gas_price_strategy',
